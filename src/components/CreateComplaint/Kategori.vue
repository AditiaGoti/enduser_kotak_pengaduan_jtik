<template>
    <div class="text-left border-none w-[500px] p-4">
        ...
        <p class="font-bold md:text-md md:mx-0 mx-14 text-sm my-3"> Pilih Kategori Pengaduan </p>
        <p class="text-sm mb-5 md:mx-0 mx-14"> Pilih kategori pengaduan yang sesuai dengan konten pengaduan yang anda sampaikan </p>
...
.click-selected {
  outline-color: red; /* Change to the desired color */
}
...
methods: {
    handleCategoryClick(categoryId) {
      this.$emit('categorySelected', categoryId); // Mengirim nilai sebagai event dengan nama 'categorySelected'
    },
    },
}
</script>
