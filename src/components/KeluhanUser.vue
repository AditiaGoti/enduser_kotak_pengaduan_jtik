<template>
  <div class="mt-24 px-36">
    <p class="font-sans text-2xl text-left font-bold mb-4 underline">Keluhan Pengguna</p>
...
visibleComplaintList: [],
  ...
  this.updateVisibleComplaintList();
     ...
     updateVisibleComplaintList() {
      ...
      async getComplaintListUser(page, size) {
        return this.complaint.getComplaintListUser(page, size);
      },
      async getComplaint() {
        await this.getComplaintListUser(this.meta.page, this.meta.size);
      },
    },
  }
  </script>
