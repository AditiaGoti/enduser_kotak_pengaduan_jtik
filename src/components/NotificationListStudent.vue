<template>
 ...
 <p class="ml-[2px]"> {{ NotificationData.unOpened }} </p>
  ...
  <div v-else>
    ...
    <!-- Dropdown menu -->
    <div  
    v-if="isDropdownOpen" class="absolute z-50 bottom-0 top-14 w-64 h-10 right-20 max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700" >
...
mounted() {
 this.getNotifList();
//  this.getNotifListComplaint();
this.updateStatusNotif()
// this.getNotifListUnopenned();
