...
<div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="flex flex-col items-center pb-10">
        ...
        <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Aditia Goti</h5>
        <span class="text-sm text-gray-500 dark:text-gray-400">TI-CCIT</span>
        <span class="text-sm text-gray-500 dark:text-gray-400">CCIT-8</span>
