<template>
  <div class="mt-24 flex flex-col items-center border-none md:px-0 px-5">
...
<div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="flex flex-col items-center pb-10">
        ...
        <h5 class="mb-1 md:text-xl text-lg font-bold text-gray-900 dark:text-white">{{profileLecturer.name}}</h5>
